...
declare function fclient_history(id: Number): Promise<string>;
declare function fclient_listen_reply(id: number, cb: EventCallback<tag_fmsg>): Promise<UnlistenFn>;
declare const _default: {
    add_fclient: typeof add_fclient;
    drop_fclient: typeof drop_fclient;
    fclient_request: typeof fclient_request;
    fclient_history: typeof fclient_history;
